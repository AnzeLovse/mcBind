...
for x in range (0,1):
    ...
    X_train, X_test = X, np.dstack((get_cobinding(protein,"test"), get_seq(protein,"test"), get_region(protein,"test"), get_fold(protein, "test")))
    y_train, y_test = y, get_class(protein,"test")
